...
# Total:        114  160  28.0    172     199#
 ...
 ab -n 10 -v 4 -p data.json -T 'application/json' -H 'Authorization: Bearer 9dkKqqpf48tnVV6uqPwil2a2kM3YKOjE' http://f0e6e5c0-66e7-4ad9-b212-ff2d5ca20a50.eastus.azurecontainer.io/score
